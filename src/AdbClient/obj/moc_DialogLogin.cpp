...
QT_MOC_LITERAL(1, 12, 11), // "signalLogin"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 19) // "on_btnLogin_clicked"

    },
    "DialogLogin\0signalLogin\0\0on_btnLogin_clicked"
};
...
void DialogLogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DialogLogin::signalLogin)) {
                *result = 0;
                return;
            }
        }
